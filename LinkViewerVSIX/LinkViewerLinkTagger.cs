...
namespace LinkViewerVSIX
{
	...
	public class LinkViewerLinkTagger : ITagger<LinkViewerLinkTag>
	{
		...
		{
			if (e.NewSnapshot == e.OldSnapshot) return;
		...
		public IEnumerable<ITagSpan<LinkViewerLinkTag>> GetTags(NormalizedSnapshotSpanCollection spans)
		{
			if (CurrentWord == null)
				yield break;
			...
			if (spans.OverlapsWith(new NormalizedSnapshotSpanCollection(currentWord)))
				yield return new TagSpan<LinkViewerLinkTag>(currentWord, new LinkViewerLinkTag());

			// Second, yield all the other words in the file 
			foreach (SnapshotSpan span in NormalizedSnapshotSpanCollection.Overlap(spans, wordSpans))
			{
				yield return new TagSpan<LinkViewerLinkTag>(span, new LinkViewerLinkTag());
			}
		}
